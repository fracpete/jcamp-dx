...
/**
 * Prototype implementation for 1D data ranges.
 * 
 * @author Thomas Weber
 */
public abstract class Range1D extends Range {
	...
	public static class Int extends Range1D implements Range.Int {
		...
		/**
		 * create range [min(<code>l</code>,<code>r</code>), max(<code>l</code>,
		 * <code>r</code>)]
		 * 
		 * @param l
		 *            int
		...
		/**
		 * clip range <code>x0,x1</code>. return <code>null</code> if range is
		...
		/**
		 * set range to interval [min(<code>l</code>,<code>r</code>), max(
		...
		/**
		 * gets union of [<code>xmin</code>,<code>xmax</code> ] with
	 ...
	 * @author Thomas Weber
	 */
	public static class Double extends Range1D implements Range.Double,
			Cloneable {
		...
		/**
		 * clip range to <code>x0,x1</code>. return <code>null</code> if range
		 * is outside or on border
		 * 
		 * @param x0
		 *            double
		 * @param x1
		...
		public boolean equals(Object obj) {
			if (obj instanceof Range1D) {
				...
				if (this == r
						|| (Math.abs(r.getXMinAsDouble() - xmin) < DOUBLE_EPS && Math
								.abs(r.getXMaxAsDouble() - xmax) < DOUBLE_EPS))
					return true;
			}
			return false;
		}
		...
		/**
		 * set range to interval [min(<code>x0</code>,<code>x1</code>), max(
		 * <code>x0</code>,<code>x1</code>)]
		 * 
		 * @param x0
		 *            double
	...
	public static class Float extends Range1D implements Range.Float, Cloneable {
		...
		public Range1D.Float clip(Range1D r) {
			return clip((float) r.getXMinAsDouble(),
					(float) r.getXMinAsDouble());
		}
		...
		public boolean equals(Object obj) {
			if (obj instanceof Range1D) {
				Range1D r = (Range1D) obj;
				if (this == r
						|| (Math.abs(r.getXMinAsDouble() - xmin) < FLOAT_EPS && Math
								.abs(r.getXMaxAsDouble() - xmax) < FLOAT_EPS))
					return true;
			}
			return false;
		}
		...
		public boolean equals(Range1D.Float r) {
			if (this == r
					|| (Math.abs(r.xmin - xmin) < FLOAT_EPS && Math.abs(r.xmax
							- xmax) < FLOAT_EPS))
				return true;
			return false;
		}
