 ...
 * @author Thomas Weber
 */
public abstract class Range2D extends Range implements java.io.Serializable {
    /**
     * 2D data range
     * @author Thomas Weber
     */
     ...
     * @author Thomas Weber
     */
    public static class Double extends Range2D implements Range.Double, Cloneable {
        /** x minimum value */
        private double xmin;
