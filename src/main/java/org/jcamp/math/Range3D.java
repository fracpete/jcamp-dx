...
/**
 * Prototype implementation for 3D data ranges.
 * 
 * @author Thomas Weber
 */
public abstract class Range3D extends Range {
	 ...
	 * @author Thomas Weber
	 */
	public static class Int extends Range3D implements Range.Int, Cloneable {
		...
		/**
		 * create range [min(<code>x0,x1</code>), max(<code>x0,x1</code>)] [min(
		 * <code>y0,y1</code>), max(<code>y0,y1</code>)] [min(<code>z0,z1</code>
		 * ), max(<code>z0,z1</code>)]
		 * 
		 * @param x0
		 *            int
		...
		/**
		 * clip range <code>x0,x1,y0,y1,z0,z1</code>. return <code>null</code>
		 * if range is outside or on border
		 * 
		 * @param x0
		 *            int
		 * @param x1
		...
		/**
		 * clip range <code>r</code>. return <code>null</code> if range is
		 * outside or on border
		 * 
		 * @return Range3D.Int
		 * @param r
		 *            Range3D.Int
		...
		/**
		 * include [<code>xmin,xmax</code> ],[<code>ymin,ymax</code> ],[
		 * <code>zmin,zmax</code> ] in range.
		 * 
		 * @param xmin
		 *            int
		 * @param xmax
		 ...
		 * @return Range3D.Int (this)
		 */
		public Range3D.Int include(int xmin, int xmax, int ymin, int ymax,
				int zmin, int zmax) {
			if (xmin < this.xmin)
				this.xmin = xmin;
			if (xmax > this.xmax)
		...
		public Range3D.Int include(Range3D.Int range) {
			return include(range.getXMin(), range.getXMax(), range.getYMin(),
					range.getYMax(), range.getZMin(), range.getZMax());
		}

		/**
		 * set range to [min(<code>x0,x1</code>), max(<code>x0,x1</code>)] [min(
		 * <code>y0,y1</code>), max(<code>y0,y1</code>)] [min(<code>z0,y1</code>
		 * ), max(<code>y0,y1</code>)]
		 * 
		 * @param x0
		 *            int
		 ...
		 *            int
		 */
		public void setCenterAndWidth(int xcenter, int xwidth, int ycenter,
				int ywidth, int zcenter, int zwidth) {
		...
		public String toString() {
			return new StringBuilder().append('[').append(xmin).append(',')
					.append(xmax).append("],[").append(ymin).append(',')
					.append(ymax).append("],[").append(zmin).append(',')
					.append(zmax).append(']').toString();
		}
		...
		/**
		 * gets union of [<code>xmin,xmax,ymin,ymax,zmin,zmax</code> ] with
		 * <code>this</code> range.
		 * 
		 * @param xmin
		 *            int
		 * @param xmax
		 ...
		 * @return Range3D.Int
		 */
		public Range3D.Int union(int xmin, int xmax, int ymin, int ymax,
				int zmin, int zmax) {
		...
		public Range3D.Int union(Range3D.Int range) {
			return union(range.getXMin(), range.getXMax(), range.getYMin(),
					range.getYMax(), range.getZMin(), range.getZMax());
		}
	}
	 ...
	 * @author Thomas Weber
	 */
	public static class Double extends Range3D implements Range.Double,
			Cloneable {
		...
		/**
		 * create range [min(<code>x0</code>,<code>x1</code>), max(
		 * <code>x0</code>,<code>x1</code>)], [min(<code>y0</code>,
		 * <code>y1</code>), max(<code>y0</code>,<code>y1</code>)] [min(
		 * <code>z0</code>,<code>z1</code>), max(<code>z0</code>,<code>z1</code>
		 * )]
		 * 
		 * @param x0
		 *            double
		 ...
		 *            double
		 */
		public Double(double x0, double x1, double y0, double y1, double z0,
				double z1) {
			super();
			if (x0 < x1) {
				this.xmin = x0;
		 ...
		 */
		public Range3D.Double clip(double x0, double x1, double y0, double y1,
				double z0, double z1) {
			...
			if (obj instanceof Range3D) {
				...
				if (this == r
						|| (Math.abs(r.getXMinAsDouble() - xmin) < DOUBLE_EPS
								...
								&& Math.abs(r.getZMinAsDouble() - zmin) < DOUBLE_EPS && Math
								.abs(r.getZMaxAsDouble() - zmax) < DOUBLE_EPS))
					return true;
			}
			return false;
		}
		...
		public Range3D.Double include(Range3D range) {
			return include(range.getXMinAsDouble(), range.getXMaxAsDouble(),
					range.getYMinAsDouble(), range.getYMaxAsDouble(),
					range.getZMinAsDouble(), range.getZMaxAsDouble());
		}
		...
		/**
		 * set range to [min(<code>x0,x1</code>), max(<code>x0,x1</code>)],
		 * [min(<code>y0,y1</code>), max(<code>y0,y1</code>)] [min(
		 * <code>z0,z1</code>), max(<code>z0,z1</code>)]
		 * 
		 * @param x0
		 *            double
		 * @param x1
		 ...
		 *            double
		 */
		public void set(double x0, double x1, double y0, double y1, double z0,
				double z1) {
			if (x0 < x1) {
				this.xmin = x0;
				this.xmax = x1;
		 ...
		 *            double
		 */
		public void setCenterAndWidth(double xcenter, double xwidth,
				double ycenter, double ywidth, double zcenter, double zwidth) {
		...
		/**
		 * gets union of <code>(xvalue,yvalue,zvalue)</code> with
		 * <code>this</code> range.
		 * 
		 * @param xvalue
		 *            double
		 ...
		 * @return Range3D.Double
		 */
		public Range3D.Double union(double xmin, double xmax, double ymin,
		 ...
		 * @return Range3D.Double (this)
		 */
		public Range3D.Double include(double xmin, double xmax, double ymin,
				double ymax, double zmin, double zmax) {
			if (xmin < this.xmin)
				this.xmin = xmin;
			if (xmax > this.xmax)
	 ...
	 * @author Thomas Weber
	 */
	public static class Float extends Range3D implements Range.Float, Cloneable {
		...
		/**
		 * create range [min(<code>x0,x1</code>), max(<code>x0,x1</code>)],
		 * [min(<code>y0,y1</code>), max(<code>y0,y1</code>)] [min(
		 * <code>z0,z1</code>), max(<code>z0,z1</code>)]
		 * 
		 * @param x0
		 ...
		 */
		public Range3D.Float clip(float x0, float x1, float y0, float y1,
				float z0, float z1) {
			...
			if (obj instanceof Range3D) {
				...
				if (this == r
						|| (Math.abs(r.getXMinAsDouble() - xmin) < FLOAT_EPS
								...
								&& Math.abs(r.getZMinAsDouble() - zmin) < FLOAT_EPS && Math
								.abs(r.getZMaxAsDouble() - zmax) < FLOAT_EPS))
					return true;
			}
			return false;
		}
		...
		public boolean equals(Range3D.Float r) {
			if (this == r
					|| (Math.abs(r.xmin - xmin) < FLOAT_EPS
							...
							&& Math.abs(r.zmin - zmin) < FLOAT_EPS && Math
							.abs(r.zmax - zmax) < FLOAT_EPS))
				return true;
			return false;
		}
		...
		public Range3D.Float include(Range3D range) {
			return include((float) range.getXMinAsDouble(),
		 ...
		 *            float
		 */
		public void set(float x0, float x1, float y0, float y1, float z0,
				float z1) {
			if (x0 < x1) {
				this.xmin = x0;
				this.xmax = x1;
		 ...
		 *            float
		 */
		public void setCenterAndWidth(float xcenter, float xwidth,
				float ycenter, float ywidth, float zcenter, float zwidth) {
		 ...
		 * @return Range3D.Float
		 */
		public Range3D.Float union(float xmin, float xmax, float ymin,
		 ...
		 * @return Range3D.Float (this)
		 */
		public Range3D.Float include(float xmin, float xmax, float ymin,
				float ymax, float zmin, float zmax) {
			if (xmin < this.xmin)
				this.xmin = xmin;
			if (xmax > this.xmax)
		...
		public Range3D.Float union(Range3D range) {
			return union((float) range.getXMinAsDouble(),
					(float) range.getXMaxAsDouble(),
					(float) range.getYMinAsDouble(),
					(float) range.getYMaxAsDouble(),
					(float) range.getZMinAsDouble(),
	...
	public boolean contains(Range3D r) {
		return (r.getXMinAsDouble() >= getXMinAsDouble()
				&& r.getXMaxAsDouble() <= getXMaxAsDouble()
				&& r.getYMinAsDouble() >= getYMinAsDouble()
				&& r.getYMaxAsDouble() <= getYMaxAsDouble()
				&& r.getZMinAsDouble() >= getZMinAsDouble() && r
				.getZMaxAsDouble() <= getZMaxAsDouble());
	}
	...
	public boolean contains(Point3d p) {
		return (p.x >= getXMinAsDouble() && p.x <= getXMaxAsDouble()
				&& p.y >= getYMinAsDouble() && p.y <= getYMaxAsDouble()
				&& p.z >= getZMinAsDouble() && p.z <= getZMaxAsDouble());
	}
