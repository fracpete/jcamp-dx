...
/**
 * GC/MS spectra GC/MS are usually represented as 1D TIC-chromatogram with a 1D
 * MS-spectrum corresponding to each chromatogram data point.
 *
 * @author Thomas Weber
 */
public class GCMSSpectrum
	...
	/**
	 * return the number of massSpectra available.
	 *
	 * @return
	 */
	public int getSlaveSpectrumCount() {
		return massSpectra.length;
	}
}
