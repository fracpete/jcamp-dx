 ...
 * @author Thomas Weber
 */
public abstract class Range3D extends Range implements java.io.Serializable {
    /**
     * 3D data range
     * @author Thomas Weber
     */
     ...
     * @author Thomas Weber
     */
    public static class Double extends Range3D implements Range.Double, Cloneable {
        /** x minimum value */
        private double xmin;
