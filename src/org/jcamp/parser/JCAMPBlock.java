...
public class JCAMPBlock {
    ...
    //shk3: it is the constructor of Unit filling the idMap in Unit. Without the map
    //filled, no normalization takes place and only the second call to the parser 
    //will normalize units (see testMzdiv813() for this behaviour)
    private Unit dummyunit = new DerivedUnit("HZ","HZ","HZ");
    ...
    /**
     * find child blocks within <code>start</code> and <code>end</code> of <code>jcamp</code> string.
     * collects remaining labels in string <code>data</code>
     */
    ...
    /**
     * iterator over all data records and store them into the hashtable <code>dataRecords</code>
     */
    ...
    private void initNTuple() throws JCAMPException {
        ...
        int start = startNTupleLDR.getStart();
        int end = endNTupleLDR.getEnd();
